...
TOPICS = [
 ...
 ("osha-fall-protection-fines","OSHA Fall-Protection Fines in 2026","Penalties","Hot",
  ...
  "Fall protection is the most-cited area in all of OSHA enforcement, and the fines are not symbolic. As of 2026 a single <strong>serious</strong> fall-protection violation runs up to roughly <strong>$16,500</strong>, and because OSHA penalizes <strong>per violation</strong>, one walkthrough that flags an unguarded roof edge, a missing tie-off and an uncertified anchor can stack into five figures fast &mdash; before any injury or insurance fallout.",
  "OSHA cites fall hazards under Subpart D and the General Duty Clause, and an inspector doesn't need a complaint to do it &mdash; fall protection is a programmed emphasis-program target they can act on the moment they see an exposure 4 feet or more above a lower level. Penalties escalate from Serious to <strong>Willful or Repeat</strong> (up to about $165,000), and Failure-to-Abate adds the serious amount again for <strong>each day</strong> past the deadline.",
  "The only fine you can fully control is the one you never receive. La Gala closes fall-protection gaps under one contract &mdash; PE-sealed inspection, then self-performed guardrail, anchor and edge work &mdash; and documents the abatement so it holds up if OSHA comes back. Start with a free assessment.",
 ...
 ("cost-of-osha-citation","What an OSHA Walking-Surface Citation Really Costs","Penalties","Warm",
  ...
  "Building owners fixate on the headline penalty &mdash; up to about <strong>$16,500</strong> per serious Subpart D violation &mdash; but the citation itself is the cheapest part. The real cost is the <strong>abatement work</strong> on a forced deadline, the legal and administrative time to respond, higher workers-comp and liability premiums, and the business disruption of a stop-work or re-inspection.",
  "A citation arrives with an abatement date, and missing it triggers <strong>Failure-to-Abate</strong> penalties that accrue per day. If the same hazard is ever cited again it becomes a <strong>Repeat</strong> &mdash; up to roughly $165,000 &mdash; and a documented OSHA history follows you into insurance renewals and contractor prequalification. One serious injury from the same hazard dwarfs all of it.",
  "Handling it correctly the first time is far cheaper than handling it twice. We scope the full cost up front, self-perform the repairs to the engineer's spec, and hand you an abatement package that closes the citation cleanly &mdash; so it never reopens as a Repeat.",
 ...
 ("repeat-willful-violations","OSHA Repeat &amp; Willful Violations, Explained","Penalties","Warm",
  ...
  "Not all OSHA violations are priced the same. A <strong>Serious</strong> violation tops out around $16,500, but a <strong>Repeat</strong> (the same or a substantially similar standard cited again) or a <strong>Willful</strong> violation (knowing, or with plain indifference) jumps to as much as roughly <strong>$165,000</strong> each &mdash; a 10x multiplier on the very same hazard.",
  "The classification is set by OSHA, and walking-working-surface items are common Repeat candidates because the same spalled walkway or uncertified anchor tends to resurface. A prior citation on file is what arms the Repeat designation, so an uncorrected &mdash; or re-occurring &mdash; hazard is the trap. These maximums also adjust upward for inflation every January.",
 ...
 ("miami-dade-roof-anchors","Miami-Dade Roof Anchor &amp; Tie-Off Requirements","§1910.27","Warm",
  ...
  "Any South-Florida building where workers access the roof to service HVAC, clean windows or maintain equipment needs <strong>certified anchorage</strong>. OSHA §1910.27 requires rope-descent-system anchorages and tie-off points to be identified, inspected, tested and <strong>certified</strong> &mdash; and in the Miami-Dade and Broward high-rise environment, salt air and sun accelerate the corrosion that makes an old anchor unsafe.",
  "Rope-descent anchorages must be certified at least <strong>every 10 years</strong> under §1910.27(b), and the building owner is responsible for keeping that certification on file and informing every contractor before work begins. Coastal exposure often means anchors need attention well before the 10-year mark.",
 ...
 ("florida-milestone-inspection-osha","Florida Milestone Inspections &amp; OSHA Subpart D","FL §553.899","Hot",
  ...
  "Florida's <strong>Milestone Inspection</strong> law (SB 4-D, FS 553.899) requires condos and co-ops three stories or taller to pass a structural inspection, and the reviewing engineer documents the exact conditions OSHA also cites &mdash; spalling walkways, corroded railings, failed waterproofing and loose rooftop anchors. The milestone report effectively hands you a list of Subpart D hazards in writing.",
  "The first milestone comes due at <strong>30 years</strong> (25 if within three miles of the coast), then repeats every 10 years; Miami-Dade and Broward layer a 40-year recertification on top. Once an engineer flags deficiencies, the repair plan carries its own deadline &mdash; and an unaddressed report is both a structural and an OSHA liability.",
  ...
  "",(("description","What the milestone flags"),("event","The 30 / 40-year clock"),("construction","How we close the report")),"ramps-walkways"),
 ("parking-garage-safety","Parking-Garage Walking-Surface Compliance","§1910.22","Warm",
  ...
  "The surface has to be kept clean, orderly, drained and in good repair, and any edge with a 4-foot-plus drop needs guarding &mdash; with no inspection interval that excuses a gap. Garages also feed milestone and 40-year recertification findings, so problems get flagged from multiple directions.",
 ...
 ("retail-rooftop-units","Rooftop HVAC Access &amp; Fall Protection for Retail","§1910.28","Warm",
  ...
  "OSHA requires protection for low-slope roof work based on how close the work is to the edge, and the duty applies whenever the exposure exists &mdash; it doesn't wait for a scheduled inspection. Multi-tenant retail roofs see frequent vendor traffic, which raises the odds someone is exposed on any given day.",
 ...
 ("guardrail-requirements","OSHA Guardrail Height &amp; Strength Requirements","§1910.29","Warm",
  ...
  "A guardrail only counts if it meets the numbers. OSHA §1910.29 requires a top rail <strong>42 inches</strong> (plus or minus 3) above the walking surface, a midrail near the halfway point, and the system must withstand at least <strong>200 pounds</strong> of force applied in any outward or downward direction &mdash; criteria a lot of older or improvised railings quietly fail.",
 ...
 ("rope-descent-recertification","Rope-Descent (Window-Washing) Anchor Recertification","§1910.27","Warm",
  ...
  "If a building uses a rope descent system &mdash; the rigging window washers and façade crews suspend from &mdash; OSHA §1910.27 makes the <strong>building owner</strong> responsible for the anchorages. Each anchor must be identified, inspected, tested and <strong>certified</strong>, and the owner has to give every contractor written assurance the anchors are sound before work begins.",
  "The hard requirement is <strong>recertification at least every 10 years</strong>, and in South Florida's salt-air environment anchors often degrade faster than that. No certification on file means no compliant rope-descent work &mdash; and direct owner liability if a crew rigs to an untested anchor.",
 ...
 ("roof-anchor-recert-frequency","How Often Must Roof Anchors Be Recertified?","§1910.27","Hot",
  "The straight answer: at least every 10 years.",
  "It's the question every building owner eventually asks, and OSHA's answer is specific: rope-descent-system anchorages must be inspected, tested, certified and maintained <strong>at least every 10 years</strong> under §1910.27(b). Other fall-arrest anchors and tie-offs should be inspected far more often &mdash; before each use and at least annually by a competent person.",
  "The 10-year certification is the maximum interval, not a target; coastal corrosion, roof work, or any sign of damage resets the clock and demands a fresh test. The owner must keep the certification on file and provide it to contractors &mdash; missing paperwork is itself the violation, even on a sound anchor.",
  ...
  "",(("schedule","The 10-year answer"),("checklist","What resets the clock"),("event_repeat","How we keep you current")),"roof-anchors"),
 ...
 ("annual-fall-protection-inspection","Annual Fall-Protection Inspection Requirements","§1910.140","Warm",
  ...
  "Fall-protection gear and anchors aren't install-and-forget. OSHA requires personal fall-arrest equipment to be inspected <strong>before each use</strong> and removed from service when defective, and rope-descent anchorages to be <strong>certified every 10 years</strong> &mdash; with a competent-person review of the systems on a regular basis in between.",
  "Harnesses, lanyards and connectors get a documented periodic inspection (annually is the common competent-person standard), while structural anchors follow the 10-year certification clock. In a coastal climate, UV and salt shorten the life of webbing and hardware, so intervals should be treated as maximums.",
...
LASTMOD="2026-06-09"
sm_urls=[(BASEW+"/wwslgc","1.0","weekly"),(BASEW+"/guides","0.8","weekly")]+[(BASEW+"/guides/"+p[0],"0.7","monthly") for p in POSTS]+[(BASEW+"/guides/"+p[0],"0.7","monthly") for p in TOPICS]
