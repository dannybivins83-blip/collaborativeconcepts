...
TOPICS = [
 ...
 ("fall-protection-emphasis-program","OSHA's Fall-Protection Emphasis Program, Explained","Enforcement","Warm",
  ...
  "You can't control when OSHA shows up &mdash; only what they find. A proactive PE-sealed inspection closes the gaps before they're cited and puts documentation on file. Our PE partner certifies it, our field team inspects it, and La Gala Construction fixes it &mdash; under one contract. Get a comprehensive assessment to find out where you stand.",
 ...
 # ---- swing-stage / suspended-scaffold TRAINING series (HOA boards, PMs, owners) ----
 ("hoa-board-swing-stage-training","Swing Stage Training: What Your HOA Board Must Verify Before a Crew Goes Over the Edge","&sect;1926.454","Hot",
  "The three questions a board should ask before any suspended work starts.",
  "When a painting, caulking or window-washing crew rigs a swing stage off your roof, OSHA &sect;1926.454 requires <strong>every worker on that scaffold to have been trained by a person qualified in the subject matter</strong> &mdash; the hazards, the fall-protection system, the load limits. Here&rsquo;s what most boards miss: under OSHA&rsquo;s <strong>multi-employer citation doctrine</strong>, the association isn&rsquo;t a bystander. If an untrained worker is hanging off your building from your anchors, the association can be cited as the controlling employer &mdash; on top of the injury liability if something goes wrong. A board that never asked is a board that owns the outcome.",
  "Before any suspended work starts, the board (or its manager) should have three things in the file: <strong>1)</strong> the contractor&rsquo;s training documentation for each worker who will be on the stage; <strong>2)</strong> the building&rsquo;s own <strong>anchor certification</strong> &mdash; the written proof required by &sect;1910.27(b) that each anchorage was inspected and load-tested; <strong>3)</strong> the contractor&rsquo;s COI naming the association. Missing any one of the three, the work should not start. Retraining is required whenever the equipment or conditions change &mdash; a crew trained on one rig isn&rsquo;t automatically qualified on another.",
  "We make the checklist easy to pass. La Gala coordinates <a class='text-secondary font-semibold hover:underline' href='/swing-stage-osha-training'>certified swing-stage training</a> through an independent qualified trainer, and our crews load-test and PE-certify the anchors and davits the stage hangs from &mdash; both halves of the file, one call.",
  "",(("priority_high","Why the board owns this"),("fact_check","The 3-item pre-work checklist"),("school","How to get it scheduled")),"window-washing"),

 ("property-manager-training-checklist","The Property Manager&rsquo;s 5-Minute Vendor Check: Training, Anchors, Paper","&sect;1926.454","Hot",
  "How a PM verifies a crew is legal before letting them rig &mdash; in five minutes.",
  "Property managers sit in the squeeze: the board expects the facade cleaned and the building painted, and every vendor swears they&rsquo;re &lsquo;fully certified.&rsquo; But when OSHA or a plaintiff&rsquo;s attorney shows up after an incident, the first two documents requested are the crew&rsquo;s <strong>scaffold training records</strong> (&sect;1926.454) and the building&rsquo;s <strong>anchorage certification</strong> (&sect;1910.27(b)). The vendor holds the first; <strong>the building holds the second</strong> &mdash; and that&rsquo;s the one that&rsquo;s almost never on file. A PM who can produce both in five minutes has done more risk management than most do in a year.",
  "The five-minute check, before keys or roof access are handed over: <strong>Ask for the training doc</strong> &mdash; who trained each worker, when, on what equipment; a card with no date or trainer name is a red flag. <strong>Pull your anchor certification</strong> &mdash; if the last load test is more than a year old (inspection) or ten years (certification), or the roof was replaced since, the anchorage is not compliant no matter how trained the crew is. <strong>Match the COI</strong> &mdash; the entity on the certificate must be the association, not just the vendor. Log all three in the building file with the work order.",
  "If either half is missing, we close it fast: <a class='text-secondary font-semibold hover:underline' href='/swing-stage-osha-training'>certified training</a> through an independent qualified trainer for the crew, and same-mobilization anchor load-testing with a PE-sealed certificate for the building. One call, both boxes checked, and the PM&rsquo;s file is inspection-proof.",
  "",(("priority_high","The squeeze PMs are in"),("fact_check","The 5-minute check"),("school","Closing the gaps in one call")),"roof-anchors"),

 ("building-owner-training-duty","You Own the Building &mdash; Here&rsquo;s the Half of &lsquo;Trained &amp; Certified&rsquo; You Can&rsquo;t Delegate","&sect;1910.27(b)","Hot",
  "The contractor trains the crew. The owner certifies the anchorage. Only one of those is yours &mdash; and it&rsquo;s not optional.",
  "Owners often assume the contractor &lsquo;handles safety.&rsquo; Half right. The contractor is responsible for training their workers (&sect;1926.454, &sect;1910.66 App&nbsp;C for powered platforms). But OSHA &sect;1910.27(b) puts a duty squarely on the <strong>building owner</strong>: before any rope-descent work, the owner must inform the employer <strong>in writing</strong> that each anchorage has been identified, tested and maintained to hold <strong>5,000 pounds per attached worker</strong> &mdash; based on an annual inspection and a load test at least every ten years. No writing, no compliant work &mdash; even with a perfectly trained crew. And this duty can&rsquo;t be delegated to the vendor: it travels with the deed.",
  "The owner&rsquo;s file needs three living documents: the <strong>anchorage certification</strong> (PE-sealed, under ten years old, refreshed after any re-roof or structural change &mdash; a re-roof voids it); the <strong>annual inspection record</strong> from a qualified person; and the <strong>written notice</strong> handed to each contractor before they rig. If your building has a permanently installed powered platform, add the <strong>operator training documentation</strong> of &sect;1910.66 App&nbsp;C for anyone on staff who runs it.",
  "La Gala maintains all of it as one program: annual qualified-person inspections, ten-year PE-certified load tests (immediately after any re-roof), the written contractor notices, and <a class='text-secondary font-semibold hover:underline' href='/swing-stage-osha-training'>certified operator and crew training</a> coordinated through an independent qualified trainer. The owner&rsquo;s duty, handled &mdash; documented, on schedule, defensible.",
  "",(("priority_high","The duty that travels with the deed"),("fact_check","What the owner&rsquo;s file must hold"),("school","Putting it on autopilot")),"fall-protection-emphasis-program"),

 ("window-washing-crew-training","Is Your Window-Washing Crew Actually Trained? How to Tell Before They Hang","&sect;1910.27","Warm",
  "&lsquo;We&rsquo;ve done this for years&rsquo; is not a training record.",
  "Window washing looks routine right up until it isn&rsquo;t &mdash; suspended work is among the least forgiving trades in construction, and South Florida&rsquo;s towers put crews over the edge every week. OSHA requires rope-descent and suspended-scaffold workers to be trained by a <strong>qualified person</strong> &mdash; in the equipment, the descent system, the rescue plan, and the anchorages they tie to. Experience is not the same thing: a crew can have washed glass for a decade on habits that fail the standard. The tell is simple &mdash; <strong>ask for the paper</strong>. A legitimate crew produces dated training records naming the trainer instantly; a crew that gets defensive just answered your question.",
  "What the record should show: <strong>who</strong> delivered the training and their qualification; <strong>when</strong> (retraining is triggered by new equipment, new site conditions, or observed deficiencies &mdash; not a fixed expiry, so &lsquo;years ago&rsquo; plus a new rig means retrain); <strong>what</strong> it covered &mdash; the descent equipment in use, fall-arrest systems, and emergency/rescue procedure. Then flip it around: the crew is entitled to ask <em>you</em> for the building&rsquo;s &sect;1910.27(b) anchorage certification &mdash; the good ones do.",
  "We put buildings on the right side of both questions: <a class='text-secondary font-semibold hover:underline' href='/swing-stage-osha-training'>certified crew training</a> through an independent qualified trainer, and current PE-sealed anchor certification so the answer to a careful crew is a document, not a shrug.",
  "",(("priority_high","Why &lsquo;experienced&rsquo; isn&rsquo;t &lsquo;trained&rsquo;"),("fact_check","Reading a training record"),("school","Getting both sides current")),"window-washing"),

 ("trained-crew-certified-anchors","Trained Crew, Certified Anchors: Compliance Has Two Halves &mdash; You Need Both","&sect;1926.454","Warm",
  "A trained crew on an uncertified anchor is still a violation. So is the reverse.",
  "Suspended-access compliance is a two-key system. Key one: <strong>the people</strong> &mdash; every worker on a swing stage trained per &sect;1926.454, every powered-platform operator per &sect;1910.66 App&nbsp;C. Key two: <strong>the building</strong> &mdash; every anchorage they tie to inspected annually and load-test certified per &sect;1910.27(b) and &sect;1910.140. Turn only one key and the door stays locked: a fully trained crew clipping into an uncertified anchor is a citable violation, and a freshly certified anchor holding an untrained worker is one too. Most buildings solve whichever half a vendor happens to sell &mdash; and stay exposed on the other.",
  "The exposure math makes the point: 2026 OSHA penalties run to <strong>$16,550 per serious violation</strong> and up to <strong>$165,514 for willful or repeat</strong> &mdash; per item, and under the multi-employer doctrine the association can be cited alongside the contractor. A morning of training plus an anchor load-test costs a fraction of one citation, before an injury claim ever enters the picture.",
  "This is exactly why we bundle it: <a class='text-secondary font-semibold hover:underline' href='/swing-stage-osha-training'>certified training</a> delivered through an independent qualified trainer, anchor and davit load-testing with PE-sealed certification by our engineering partner, and corrective work self-performed by our crews if anything fails. Two halves, one contract, one file that passes inspection.",
...
<meta property="og:title" content="{title_plain} | Roof Anchor Cert"/>
...
<a href="/" class="flex items-center" aria-label="Roof Anchor Cert"><span class="text-2xl font-extrabold text-primary tracking-tight">Roof Anchor Cert</span></a>
...
<a href="/" class="inline-block text-2xl font-extrabold tracking-tight text-[#f8f7f5]">Roof Anchor Cert</a>
...
<p class="text-xs text-[#f8f7f5]/40 max-w-3xl">Corrective and construction work is performed by <a class="text-[#e8c547] font-semibold hover:underline" href="https://lagalacon.com" rel="noopener">La Gala Construction</a> (FL CGC 059211), a Florida State Certified General Contractor. Engineering certifications referenced are performed and sealed by an independent, licensed Florida professional engineer. Site operated by Collaborative Concept LLC, an independent inspection and compliance company, which does not provide engineering or contracting services.</p>
...
<p class="text-on-primary/75 mt-3 max-w-2xl mx-auto">Our PE partner certifies it, our field team inspects it, and La Gala Construction fixes it &mdash; under one contract. Start with a comprehensive, no-obligation assessment, or build a custom compliance plan in two minutes.</p>
...
<p class="text-on-primary/75 mt-5 text-sm">Window-washing or swing-stage crews on your facade? Start with <a class="text-secondary-fixed font-semibold hover:underline" href="/tie-back-anchor-inspection-load-testing">tie-back anchor inspection &amp; load testing</a>.</p>
</div></div>"""
